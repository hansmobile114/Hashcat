...
- (void)commonInit {
    ...
    tagInputField_.font = [UIFont fontWithName:MAIN_FONT_NAME size:14];
...
- (void)reloadTagSubviews {
    ...
    for (NSString *tag in _tags) {
        ...
        tagView.layer.cornerRadius = tagView.frame.size.height / 2.f;
...
- (void)deleteTagButton:(UIButton *)sender {
    ...
    [tapDelegate deleteTagsControl:self tappedAtIndex:index];
