...
#define loaderBlurViewShow YES
#define loaderBackgroundColor [UIColor clearColor]
#define loaderCornerRadius 5
#define loaderBackgroundWidth 180
#define loaderBackgroundHeight 120
...
#define animationImageWidth 160
#define animationImageHeight 160
#define numberOfFramesInAnimation 5
#define spriteNameString @"selected_hascat"
...
#define loadingTextFontName @"Avenir-Book"
#define loadingTextFontSize 14.f
